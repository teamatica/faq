...
Весь смысл приложения в том, чтобы обеспечивать всех пользователей всей информацией, поэтому, к сожалению, скрыть никого не получится, но можно добавлять учётные записи без указания контактной информации.
<br/>
<br/>
<br/>
<br/>
