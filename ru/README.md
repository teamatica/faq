...
Такой способ распространения в корне противоречит требованию валидного TLS-соединения с доменом организации. Технически невозможно выпускать универсальные образы с предустановленным и преднастроенным HTTPS, потому что сертификаты и доменные имена — в зоне контроля и ответственности организации. Тем не менее, индексный PHP-файл можно использовать в любом окружении (включая Docker), которое соответствует актуальным системным требованиям.
<br/>
<br/>
<br/>
<br/>
