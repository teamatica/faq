...
Готовый универсальный Docker-образ невозможен из-за требований к HTTPS: приложение использует валидное TLS-соединение с доменом организации, а сертификаты и доменные имена находятся в зоне ответственности администратора, не разработчика — тем не менее, [индексный PHP-файл](https://github.com/teamatica/backend/blob/main/ru/%E2%9C%85%20PHP/index.php) можно использовать в любом окружении, включая Docker, если оно соответствует [системным требованиям](https://teamatica.org/#3).
<br/>
<br/>
<br/>
<br/>
